...
> [!CAUTION]
> **免责声明:** <br>
> TeamDesk 的开发人员不纵容或支持任何不道德或非法的软件使用行为。滥用行为，例如未经授权的访问、控制或侵犯隐私，严格违反我们的准则。作者对应用程序的任何滥用行为概不负责。

与我们交流: [知乎](https://www.zhihu.com/people/teamdesk) | [Discord](https://discord.gg/nDceKgxnkV) | [Reddit](https://www.reddit.com/r/teamdesk) | [YouTube](https://www.youtube.com/@teamdesk)

[![TeamDesk Server Pro](https://img.shields.io/badge/TeamDesk%20Server%20Pro-%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD-blue)](https://teamdesk.com/pricing.html)

远程桌面软件，开箱即用，无需任何配置。您完全掌控数据，不用担心安全问题。您可以使用我们的注册/中继服务器，
或者[自己设置](https://teamdesk.com/server)，
亦或者[开发您的版本](https://github.com/rustdesk/rustdesk-server-demo)。

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

TeamDesk 期待各位的贡献. 如何参与开发? 详情请看 [CONTRIBUTING-ZH.md](CONTRIBUTING-ZH.md).
...
## [构建](https://teamdesk.com/docs/en/dev/build/)
...
cd teamdesk # 进入文件夹
docker build -t "teamdesk-builder" . # 构建容器
```
...
* 针对国内网络访问问题，可以做以下几点优化：  
   ...
   4. docker build 命令后面加上 proxy 参数
      ...
      ```
      docker build -t "teamdesk-builder" . --build-arg http_proxy=http://host:port --build-arg https_proxy=http://host:port
      ```
...
生成的可执行程序在 target 目录下，可直接通过指令运行调试 (Debug) 版本的 TeamDesk:
```sh
...
请注意：
* 请保证您运行的目录是在 TeamDesk 库的根目录内，否则软件会读不到文件。
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: 与[teamdesk-server](https://github.com/rustdesk/rustdesk-server)保持UDP通讯, 等待远程连接（通过打洞直连或者中继）
