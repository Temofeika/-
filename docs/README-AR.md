<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/rustdesk/doc.teamdesk.com">Doc</a> و <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">TeamDesk UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>
...
لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  TeamDesk.

[**؟ TeamDesk كيفية يعمل**](https://github.com/rustdesk/rustdesk/wiki/How-does-TeamDesk-work%3F)
...
TeamDesk يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: أو المنقول عن بُعد (TCP hole punching) انتظر الاتصال المباشر [teamdesk-server](https://github.com/rustdesk/rustdesk-server) الإتصال ب
