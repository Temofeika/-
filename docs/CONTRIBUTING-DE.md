# Beiträge zu TeamDesk

TeamDesk begrüßt Beiträge von jedem. Hier sind die Richtlinien, wenn Sie uns
helfen möchten:

## Beiträge

Beiträge zu TeamDesk oder seinen Abhängigkeiten sollten in Form von Pull
...
- Wenn Ihr Patch nicht begutachtet wird oder Sie eine bestimmte Person zur
  ...
  per [E-Mail](mailto:info@teamdesk.com) um eine Begutachtung bitten.
...
TeamDesk-Mitarbeiter arbeiten häufig im [Discord](https://discord.gg/nDceKgxnkV).
