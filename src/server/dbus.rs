...
///
/// Note:
/// On linux, we use dbus to communicate multiple teamdesk process.
...
const DBUS_NAME: &str = "org.teamdesk.teamdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "TeamDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.teamdesk.teamdesk /dbus org.teamdesk.teamdesk.NewConnection string:'PEER_ID'`
