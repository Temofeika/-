...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/TeamDesk.app/Contents/MacOS/TeamDesk", "XPC_SERVICE_NAME=com.carriez.TeamDesk_server"
...
pub type TeamDeskInterval = ThrottledInterval;

#[inline]
pub fn teamdesk_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_TeamDesk_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = teamdesk_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_TeamDesk_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
