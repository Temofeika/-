...
#
# Script to build F-Droid release of TeamDesk
#
# Copyright (C) 2024, The TeamDesk Authors
...
#
# - versionName from https://github.com/rustdesk/rustdesk/releases/download/fdroid-version/teamdesk-version.txt
# - versionCode from https://github.com/rustdesk/rustdesk/releases/download/fdroid-version/teamdesk-version.txt
...
prebuild)
	...
	# Install Flutter version for TeamDesk library build
...
build)
	...
	cp "target/${RUST_TARGET}/release/liblibteamdesk.so" \
		"flutter/android/app/src/main/jniLibs/${ANDROID_ABI}/libteamdesk.so"
